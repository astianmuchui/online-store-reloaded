...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2021 at 01:49 AM
...
CREATE TABLE `products` (
  ...
  `time_added` timestamp(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
